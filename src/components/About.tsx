          ...
          <div className="bg-cream/95 rounded-3xl p-8 md:p-12 border-4 border-tan/30 shadow-2xl">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-start">
              ...
              <div className="flex flex-col space-y-6">
                <div className="bg-cream p-4 md:p-6 rounded-t-[150px] md:rounded-t-[200px] shadow-2xl border-4 border-tan overflow-hidden">
                  <img 
                    src={ownerPhoto} 
                    alt="Brand Image Marketing Owner" 
                    className="w-full h-auto object-cover rounded-t-[130px] md:rounded-t-[180px]"
                  />
                </div>
                <div className="space-y-6">
                  <p className="text-lg text-foreground/90 font-body leading-relaxed">
